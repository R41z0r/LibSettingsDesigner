...
- Before opening a pull request for the sample addon release flow, add or update
  a short `Samples/LibSettingsDesignerSample/CHANGELOG.md` entry that is
  suitable for CurseForge and Wago. Keep it user-facing and focused on the
